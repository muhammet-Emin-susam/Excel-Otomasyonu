...
namespace ExcellResim.Model
{
    ...
    public partial class TBLSTOKKODUCHANGELOG
    {
        public int INCKEYNO { get; set; }
        public string ONCEKI_STOK_KODU { get; set; }
        public string SONRAKI_STOK_KODU { get; set; }
        public string SIRKET_KODU { get; set; }
        public string CURRENT_STOK_KODU { get; set; }
