...
namespace ExcellResim.Model
{
    ...
    public partial class TBLBANKAKODUCHANGELOG
    {
        public int INCKEYNO { get; set; }
        public string ONCEKI_BANKA_KODU { get; set; }
        public string SONRAKI_BANKA_KODU { get; set; }
        public string SIRKET_KODU { get; set; }
        public string CURRENT_BANKA_KODU { get; set; }
