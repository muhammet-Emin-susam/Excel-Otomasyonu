...
namespace ExcellResim.Model
{
    ...
    public partial class TBLNDIBAGLANTI
    {
        public short ISLETME_KODU { get; set; }
        public short SUBE_KODU { get; set; }
        public string NDISIRKETADI { get; set; }
        public Nullable<byte> ORTAKBAG { get; set; }
        public string NDIKULADI { get; set; }
        public string NDIKULSIFRE { get; set; }
