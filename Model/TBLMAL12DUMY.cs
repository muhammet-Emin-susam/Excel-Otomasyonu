...
namespace ExcellResim.Model
{
    ...
    public partial class TBLMAL12DUMY
    {
        public short ISLETME_KODU { get; set; }
        public string DUMY { get; set; }
        public Nullable<decimal> TOPGIRMIK { get; set; }
        public Nullable<decimal> TOPGIRNET { get; set; }
        public Nullable<decimal> TOPCIKMIK { get; set; }
        public Nullable<decimal> TOPCIKNET { get; set; }
