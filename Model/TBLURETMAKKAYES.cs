...
namespace ExcellResim.Model
{
    ...
    public partial class TBLURETMAKKAYES
    {
        ...
        public short KAY_DEGER_TIPI { get; set; }
        public string KAY_DEGER { get; set; }
        public short URUN_DEGER_TIPI { get; set; }
        public string URUN_DEGER { get; set; }
        public Nullable<int> KAYNAKSAYISI { get; set; }
        public short SETNO { get; set; }
        public short SET_ONCELIK { get; set; }
        ...
        public Nullable<decimal> OMUR_TUKETIMI { get; set; }
        public string SADECE_HAZIRLIK_ICIN { get; set; }
