...
namespace ExcellResim.Model
{
    ...
    public partial class TBLPAKETMAS
    {
        public string PAKET_KODU { get; set; }
        public string ACIKLAMA { get; set; }
        public Nullable<decimal> BOS_AGIRLIK { get; set; }
        public string GRUP { get; set; }
        public Nullable<decimal> MAX_AD { get; set; }
        public Nullable<decimal> MAX_KG { get; set; }
