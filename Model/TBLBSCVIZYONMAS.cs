...
namespace ExcellResim.Model
{
    ...
    public partial class TBLBSCVIZYONMAS
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public TBLBSCVIZYONMAS()
        {
            this.TBLBSCMISYONMAS = new HashSet<TBLBSCMISYONMAS>();
        }
    
        public int INCKEYNO { get; set; }
        public int MODELINCKEYNO { get; set; }
        public string VIZYONKOD { get; set; }
        ...
        public virtual ICollection<TBLBSCMISYONMAS> TBLBSCMISYONMAS { get; set; }
