...
namespace ExcellResim.Model
{
    ...
    public partial class TBLFASTREPORTDIZAYN
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public TBLFASTREPORTDIZAYN()
        {
            this.TBLFASTREPORTDATA = new HashSet<TBLFASTREPORTDATA>();
        }
    
        public int DIZAYNID { get; set; }
        public string KOD { get; set; }
        public Nullable<int> DIZAYN_TIP { get; set; }
        ...
        public virtual ICollection<TBLFASTREPORTDATA> TBLFASTREPORTDATA { get; set; }
    }
}
