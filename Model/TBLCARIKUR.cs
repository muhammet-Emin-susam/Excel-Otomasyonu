...
namespace ExcellResim.Model
{
    ...
    public partial class TBLCARIKUR
    {
        ...
        public Nullable<double> DOV_ALIS { get; set; }
        public Nullable<double> DOV_SATIS { get; set; }
        public Nullable<double> EFF_ALIS { get; set; }
        public Nullable<double> EFF_SATIS { get; set; }
