...
namespace ExcellResim.Model
{
    ...
    public partial class TBLRAPORSONUC
    {
        ...
        public string RAPOR_ACIKLAMA { get; set; }
        public string RAPOR_GUID { get; set; }
        public Nullable<short> RAPOR_TIPI { get; set; }
        public Nullable<int> PARENT_TASLAK_ID { get; set; }
        public byte[] ONSORGU { get; set; }
