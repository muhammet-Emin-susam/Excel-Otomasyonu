...
namespace ExcellResim.Model
{
    ...
    public partial class TBLMASRAFPARAM
    {
        public int INCKEYNO { get; set; }
        public string HESDETAY_TAKIP_EDILSIN { get; set; }
        public string ODEME_MASRAF_DEGISTIR { get; set; }
        public string ODEME_MASRAF_ISAKIS { get; set; }
