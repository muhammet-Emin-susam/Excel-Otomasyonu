...
namespace ExcellResim.Model
{
    ...
    public partial class TBLFIYFARKTRA
    {
        public int INCKEYNO { get; set; }
        public int MASINCKEYNO { get; set; }
        public string FATSTOKKODU { get; set; }
        public string FARKFATSTOKKODU { get; set; }
        public Nullable<int> SIPINCKEYNO { get; set; }
        public int STHARINCKEYNO { get; set; }
        ...
        public virtual TBLFIYFARKMAS TBLFIYFARKMAS { get; set; }
    }
}
