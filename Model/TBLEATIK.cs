...
namespace ExcellResim.Model
{
    ...
    public partial class TBLEATIK
    {
        public int INCKEYNO { get; set; }
        public short SUBE_KODU { get; set; }
        public string KAYITTIPI { get; set; }
        public string ATIK_KODU { get; set; }
        public string ATIIK_ADI { get; set; }
        public Nullable<System.DateTime> ATIK_TARIH { get; set; }
        public Nullable<decimal> ATIK_MIKTAR { get; set; }
        public Nullable<decimal> ATIK_AGIRLIK { get; set; }
        public string GERI_DONUSTURULDU { get; set; }
        public string ATIK_ACIKLAMA { get; set; }
